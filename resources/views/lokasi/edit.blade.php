            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('biaya.update', $lokasi->id) }}" method="POST">
                        ...
                        <div>
                            <label for="transportasi">Biaya Transportasi:</label>
                            <input class="form-control" type="text" name="transportasi" id="transportasi" value="">
                        </div>
                        <div>
                            <label for="pemasangan">Biaya Pemasangan:</label>
                            <input class="form-control" type="text" name="pemasangan" id="pemasangan" value="">
                        </div>
                        <div>
                            <label for="jasa">Biaya Jasa:</label>
                            <input class="form-control" type="text" name="jasa" id="jasa" value="">
                        </div>
                        <div>
                            <label for="service">Biaya Service:</label>
