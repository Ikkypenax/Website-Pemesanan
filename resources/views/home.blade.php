...
@section('content')
    ...
    <div class="container testi" style="padding: 50px 0px">
        <div class="section-heading text-black wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
            <h4 class="text-red">Produk Unggulan Yang Kami Tawarkan </h4>
            <p class="opacity-75">Berikut adalah produk videtron yang sering dan banyak dipesan oleh berbagai EO serta
                produk yang memiliki kualitas unggulan.
            ...
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                <img src="https://i.pinimg.com/originals/85/39/12/8539121611693888d68bef623138b3db.jpg" alt="Avatar 1" class="rounded-circle me-3">
                                <div>
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                <img src="https://i.pinimg.com/originals/85/39/12/8539121611693888d68bef623138b3db.jpg" alt="Avatar 2" class="rounded-circle me-3">
                                <div>
