        ...
        <div class="d-flex" style="gap:12px">
            ...
            <div class="w-25">
                <div class="h-100 service-item d-flex flex-column justify-content-center second-service">
                    ...
                    <p class="opacity-50">Tim kami terus menjelajahi teknologi terbaru untuk memberikan solusi yang
                        inovatif
                        dan efektif.</p>
                </div>
            </div>
            <div class="w-25">
                <div class="h-100 service-item d-flex flex-column justify-content-center third-service">
                    ...
                    <p class="opacity-50">Kami memprioritaskan kebutuhan klien kami, menawarkan layanan dan dukungan
                        yang
                        dipersonalisasi
            ...
            <div class="w-25">
                <div class="h-100 service-item d-flex flex-column justify-content-center fourth-service">
                    ...
                    <p class="opacity-50">Tim kami terdiri dari profesional berpengalaman yang bersemangat dengan apa
                        yang
                        mereka lakukan
                    </p>
                </div>
