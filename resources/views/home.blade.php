...
@section('content')
    ...
    <div class="main-banner wow fadeIn"
        style="background-image: url('{{ asset('assets/images/background.jpg') }}'); height: 100vh;">
        <div class="container">
            <div class="row">
                    ...
                    <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="w-100">
                            ...
                            <p>Kami bergerak dalam bidang layanan fotografi dan pengadaan videotron.
                                Dengan dedikasi dan komitmen tinggi, kami menyediakan solusi visual berkualitas tinggi yang
                                dirancang
